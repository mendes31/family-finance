<?php
/**
 * Script para forçar reexecução de migrations que falharam
 * Remove os registros e reexecuta automaticamente
 */
...
try {
    ...
    foreach ($migration_to_table as $migration => $table) {
        if (!in_array($table, $existing_tables)) {
            ...
            $cleaned++;
            $migrations_to_reexecute[] = $migration;
        }
    }
    ...
    if ($cleaned > 0) {
        ...
        echo "   Ou execute manualmente as migrations no phpMyAdmin.\n";
    } else {
